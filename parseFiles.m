...
c1 = csvread('~/Desktop/SeniorDesign/SD Sample Data/IMUs Clench/beaconLocationData1.txt');
c2 = csvread('~/Desktop/SeniorDesign/SD Sample Data/IMUs Clench/beaconLocationData2.txt');
c3 = csvread('~/Desktop/SeniorDesign/SD Sample Data/IMUs Clench/beaconLocationData0.txt');
...
if (nargin == 4)
    ...
    %uncertaintyData = [uncertaintyData; shortestDistInches];
...
elseif (nargin == 6)
    ...
    uncertaintyData = [uncertaintyData; totalUncertainty]
